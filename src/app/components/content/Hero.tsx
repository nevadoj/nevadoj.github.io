  ...
  return (
    <>
      <div className="flex flex-col items-center sm:items-start w-full">
        <img src="/assets/images/icon.png" alt="website icon" width={60} height={60} className="mx-12"/>

        <div className="flex flex-col justify-center items-center w-full pt-24 sm:flex-row sm:pt-36">
