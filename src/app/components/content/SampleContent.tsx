    ...
    return(
        <>
            <div>
                ...
                <Container>
                    <div className="flex justify-center items-start lg:justify-start xl:justify-center lg:col-span-5 2xl:col-span-6">
                        <p className="text-2xl xl:pl-16">Hello 👋</p>
                    </div>
                    <div className="flex flex-col justify-center items-center lg:justify-start lg:items-start lg:col-span-7 2xl:col-span-6">
