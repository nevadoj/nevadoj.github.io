...
export default function Home() {
  return (
    <div name="main">
      <div name="home" className="w-full bg-altbg text-white">
        <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center overflow-hidden h-full md:flex-row animate-fade-in-up">
          <div className="py-48">
