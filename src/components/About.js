  ...
  return (
    <div name="about" className="w-full h-screen bg-[#495046] text-white sm:py-2">
        <div className="max-w-screen-lg mx-auto bg-[#495046]">
            <div className="font-light max-w-4xl mx-24 pt-32">
                <p className="text-4xl py-10">
                    I'm interested in leveraging technology for our daily lifestyles. I'm also interested in design and how it evokes emotion. Currently exploring <span className="font-medium">iOS development</span>.
                </p>
