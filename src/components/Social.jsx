...
export default function Social() {
  return (
    <div name="social"className="h-screen w-full bg-[#495046] text-white">
      <div className="max-w-screen-lg mx-auto">
        <div className="max-w-4xl mx-24">
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 48 48" strokeWidth={0.2} stroke="currentColor" className="w-16 h-16">
            ...
            <h2 className="text-4xl pl-5 pt-6">Vancouver,</h2>
            <h2 className="text-4xl pl-5 py-2">Canada</h2>
          </div>
        </div>
      </div>
    </div>
